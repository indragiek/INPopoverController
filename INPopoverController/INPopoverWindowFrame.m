...
- (NSBezierPath *)_popoverBezierPathWithRect:(NSRect)aRect
{
	...
	const CGFloat minX = NSMinX(drawingRect) + (self.arrowDirection == INPopoverArrowDirectionLeft ? self.borderWidth / 2 : 0) - (self.arrowDirection == INPopoverArrowDirectionRight ? self.borderWidth / 2 : 0);
	const CGFloat maxX = NSMaxX(drawingRect) - (self.arrowDirection == INPopoverArrowDirectionRight ? self.borderWidth / 2 : 0) + (self.arrowDirection == INPopoverArrowDirectionLeft ? self.borderWidth / 2 : 0);
	const CGFloat minY = NSMinY(drawingRect) + (self.arrowDirection == INPopoverArrowDirectionDown ? self.borderWidth / 2 : 0) - (self.arrowDirection == INPopoverArrowDirectionUp ? self.borderWidth / 2 : 0);
	const CGFloat maxY = NSMaxY(drawingRect) - (self.arrowDirection == INPopoverArrowDirectionUp ? self.borderWidth / 2 : 0) + (self.arrowDirection == INPopoverArrowDirectionDown ? self.borderWidth / 2 : 0);
